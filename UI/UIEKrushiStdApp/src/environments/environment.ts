...
export const environment = {
  ...
  //orginal before gateway
  // cartServiceUrl: 'http://localhost:5282/api/carts',
  // biServiceUrl: 'http://localhost:5161/api/bi',
  ...
  // paymentGatewayServiceUrl: 'http://localhost:5001/api',
  // corporateServiceUrl: 'http://localhost:5041/api/corporates',
